...
# mylist containes the uri, the youtube id
...
#         movie = media.Movie(result['title'], 'https://image.tmdb.org/t/p/w300_and_h450_bestv2/' + result['poster_path'], result['overview'], 'dummy', 'https://www.youtube.com/watch?v=' + 'dummy')
#         list_of_favourite_movies.append(movie)
#     except Exception as e:
#         pass

# Getting movie data by making requests to themoviedb.org API using personal API key.


# Getting movie data by making requests to themoviedb.org API using personal API key.
try:
    matrix = requests.get(
        "https://api.themoviedb.org/3/movie/603?api_key=da2bb8468c2a728673dc669aaaec512a").json()
except Exception as e:
    pass

# Extracting necessary data from json object which was returned after API request.
matrix_title = matrix['title']
matrix_poster = 'https://image.tmdb.org/t/p/w300_and_h450_bestv2/' + \
    matrix['poster_path']
matrix_overview = matrix['overview']

# Since themoviedb.org API does not contain movie trailers, id and trailer url are taken from youtube.com.
matrix_youtube_id = 'm8e-FF8MsqU'
matrix_trailer = 'https://www.youtube.com/watch?v=m8e-FF8MsqU'

# Getting movie data by making requests to themoviedb.org API using personal API key.
arrival = requests.get(
    "https://api.themoviedb.org/3/movie/329865?api_key=da2bb8468c2a728673dc669aaaec512a").json()
...
godfather = requests.get(
    "https://api.themoviedb.org/3/movie/238?api_key=da2bb8468c2a728673dc669aaaec512a").json()
...
holyMotors = requests.get(
    "https://api.themoviedb.org/3/movie/103328?api_key=da2bb8468c2a728673dc669aaaec512a").json()
...
clockworkOrange = requests.get(
    "https://api.themoviedb.org/3/movie/185?api_key=da2bb8468c2a728673dc669aaaec512a").json()
...
oneFlew = requests.get(
    "https://api.themoviedb.org/3/movie/510?api_key=da2bb8468c2a728673dc669aaaec512a").json()
...
# Creating class Movie objects which will be members of list_of_favourite_movies array.
...
godfather = media.Movie(godfather_title, godfather_poster,
                        godfather_overview, godfather_youtube_id, godfather_trailer)
holyMotors = media.Movie(holyMotors_title, holyMotors_poster,
                         holyMotors_overview, holyMotors_youtube_id, holyMotors_trailer)
clockworkOrange = media.Movie(clockworkOrange_title, clockworkOrange_poster,
                              clockworkOrange_overview, clockworkOrange_youtube_id, clockworkOrange_trailer)
...
# Using open_movies_page function with list_of_favourite_movies array to generate html displaying movies list.
